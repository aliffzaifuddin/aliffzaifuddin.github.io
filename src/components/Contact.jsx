      ...
      <div className="flex justify-center items-center h-full p-4">
        <form method='POST' action="https://getform.io/f/bcabe04f-25c6-4e1f-9f1c-82464c977943" className='flex flex-col max-w-[600px] w-full'>
          <div className='pb-8'>
            ...
            <p className='text-gray-300 py-4'>Submit the form below or send me an email - aliffzaifuddin@gmail.com</p>
          </div>
          <input className='bg-slate-200 p-2' type='text' placeholder='Name' name="name"></input>
          <input className='my-4 p-2 bg-slate-200' type='email' placeholder='Email' name="email"></input>
